...
const applications = [
  ...
  { id: '125', name: '消费券', description: '覆盖消费券发放、领取、查看与核销的全流程服务', icon: 'Coupon', path: '/coupon', status: 'developing', categoryId: '002', sort: 1 },
  { id: '126', name: '积分商城', description: '积分获取、商品兑换和兑换记录管理服务', icon: 'Shopbag', path: '/points-mall', status: 'developing', categoryId: '003', sort: 1 },
  { id: '127', name: '通用答题服务', description: '支持题库配置、在线答题、评分与结果查看', icon: 'Content', path: '/quiz', status: 'developing', categoryId: '006', sort: 1 },
  { id: '128', name: '智慧社区', description: '面向社区居民的通知、服务与事项办理入口', icon: 'Team', path: '/smart-community', status: 'developing', categoryId: '005', sort: 1 },
  { id: '129', name: '通用信息填报', description: '可配置表单、材料上传和填报记录管理服务', icon: 'Fillin', path: '/information-collection', status: 'developing', categoryId: '006', sort: 2 },
];
...
const draftData = {
  student: { name: '李昕然', documentType: '居民身份证', documentNumber: '320701201901012318', householdLocation: '海州市海州区', residenceAddress: '海州市海州区文教路18号', previousSchool: '春晖幼儿园' },
  family: { guardianName: '王芳', guardianRelation: '母亲', guardianDocument: '320701198805015678', guardianPhone: '13800005678', householdHeadName: '李伟', householdHeadRelation: '父亲', householdHeadDocument: '320701198403011234', householdHeadPhone: '13900001234', householdAddress: '海州市海州区文教路18号' },
  property: { hasProperty: true, ownerName: '李伟', ownerDocument: '320701198403011234', relation: '父亲', certificateNumber: '苏（2022）海州市不动产权第0001号', address: '海州市海州区文教路18号', usage: '住宅', area: '96.8', residenceAddress: '海州市海州区文教路18号' },
  materials: {},
};
