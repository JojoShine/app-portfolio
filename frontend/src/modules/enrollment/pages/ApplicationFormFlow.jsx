...
export const ApplicationOverviewPage = () => {
  ...
  if (!school) {
    return <div className="enrollment-page"><main className="enrollment-content"><CompactNotice type="warning">报名上下文已失效，请从“我的报名”重新进入。</CompactNotice></main></div>;
  }
      ...
      <main className="enrollment-content">
        ...
        <div className="information-timeline">
          ...
          >
            ...
            <div className="source-tags"><SourceTag type="department" /><SourceTag type="modified" /></div>
          </TimelineCluster>
          ...
          >
            ...
            <div className="source-tags"><SourceTag type="department" /></div>
          </TimelineCluster>
          ...
          >
            ...
            <div className="source-tags"><SourceTag type="manual" /><SourceTag type="fallback" /></div>
          </TimelineCluster>
        </div>
      </main>
...
export const ClusterEditPage = () => {
  ...
  const [values, setValues] = useState(draft[cluster] || draft.student);
  ...
  const selectProperty = (property) => setFields({
      ...
      <main className="enrollment-content">
        ...
        {cluster === 'student' && (
          <div className="edit-form">
            ...
            <Field label="当前居住地址" required source="modified">
              <TextArea autoSize={{ minRows: 2, maxRows: 4 }} value={values.residenceAddress} onChange={(value) => setField('residenceAddress', value)} />
              <Input className="modified-reason" value={values.modifiedReason} onChange={(value) => setField('modifiedReason', value)} placeholder="请输入修改原因" />
            </Field>
