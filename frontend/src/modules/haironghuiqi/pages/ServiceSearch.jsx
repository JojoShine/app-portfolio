    ...
    <div className="w-screen min-h-screen" style={{ background: 'linear-gradient(180deg, #eef2f7 0%, #f8fafc 50%, #eef2f7 100%)' }}>
      ...
      <main className="relative px-4 pt-6 pb-6 max-w-2xl mx-auto w-full">
        ...
        <section className="mb-6">
          <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-blue-900 to-blue-700 p-4 flex flex-row items-start gap-4 text-white shadow-lg">
            {/* 装饰元素 */}
            <div className="absolute -right-8 -top-8 w-32 h-32 bg-white opacity-5 rounded-full"></div>

            {/* 左侧图标 */}
            <div className="relative z-10 shrink-0 w-12 h-12 rounded-xl bg-white/10 flex items-center justify-center border border-white/20 mt-0.5">
            ...
            <div className="relative z-10 flex-1 min-w-0">
              <div className="flex items-center gap-2 mb-1.5">
                <span className="bg-yellow-400 text-blue-900 px-1.5 py-0.5 rounded text-[10px] font-bold uppercase tracking-wider">最新</span>
              </div>
            ...
            <div className="relative z-10 shrink-0 mt-1">
              <button onClick={() => navigate('/haironghuiqi/policy')} className="inline-flex items-center gap-1 text-yellow-400 hover:underline transition-all text-xs font-semibold bg-transparent border-none cursor-pointer whitespace-nowrap">
                了解更多 →
              </button>
            </div>
          </div>
        ...
        <nav className="mb-6">
          <div className="flex rounded-2xl p-1" style={{ background: 'rgba(200,215,240,0.3)', backdropFilter: 'blur(8px)' }}>
            <button
              ...
              className={`flex-1 py-3 text-center rounded-xl font-semibold transition-all text-sm flex items-center justify-center gap-1.5 ${
