...
const appRows = [
  ...
  ['125', '消费券', '覆盖消费券发放、领取、查看与核销的全流程服务', 'Coupon', '/coupon', 'developing', '002', 2],
  ['126', '积分商城', '积分获取、商品兑换和兑换记录管理服务', 'Shopbag', '/points-mall', 'developing', '003', 3],
  ['127', '通用答题服务', '支持题库配置、在线答题、评分与结果查看', 'Content', '/quiz', 'developing', '006', 4],
  ['128', '智慧社区', '面向社区居民的通知、服务与事项办理入口', 'Team', '/smart-community', 'developing', '005', 5],
  ['129', '通用信息填报', '可配置表单、材料上传和填报记录管理服务', 'Fillin', '/information-collection', 'developing', '006', 6],
  ['130', '城市停车助手', '查询停车场、剩余车位、收费标准并记录停车位置', 'MapPin', '/city-parking', 'developing', '007', 7],
  ['131', '公交实时到站', '查看公交线路、车辆位置、预计到站时间和换乘建议', 'Send', '/transit-arrival', 'developing', '007', 8],
  ['132', '城市便民地图', '在地图中集中查找公共设施、便民网点和服务信息', 'MapPin', '/city-service-map', 'developing', '007', 9],
  ['133', 'AI错题本', '识别错题、归纳知识点并生成针对性练习和复习计划', 'BookOpen', '/ai-error-book', 'developing', '004', 10],
  ['134', '校园接送码', '生成动态接送凭证，记录授权人员和学生接送过程', 'Shield', '/campus-pickup', 'developing', '004', 11],
  ['135', '研学任务地图', '以地图和任务卡组织研学路线、打卡与成果记录', 'MapPin', '/study-tour-map', 'developing', '004', 12],
  ['136', '电子证照卡包', '集中管理个人电子证照、授权出示和使用记录', 'File', '/digital-credentials', 'developing', '007', 13],
  ['137', '老照片修复馆', '修复老照片划痕、模糊与褪色并生成对比作品', 'Content', '/photo-restoration', 'developing', '008', 14],
  ['138', '社区闲置交换', '发布社区闲置物品，支持交换、赠送和邻里沟通', 'Team', '/community-swap', 'developing', '005', 15],
  ['139', '临时组队助手', '围绕运动、活动和兴趣快速发起并加入临时队伍', 'Users', '/team-up', 'developing', '006', 16],
  ['140', '旅行费用分账', '记录多人旅行开支，自动计算分摊结果和待结金额', 'DollarSign', '/travel-split', 'developing', '009', 17],
  ['141', '宠伴生活', '管理宠物档案、健康提醒、遛宠轨迹和走失寻回', 'Home', '/pet-life', 'developing', '009', 18],
  ['142', '独居老人安全守护', '结合居家设备监测异常状态并向家属发送安全提醒', 'Shield', '/elderly-safety', 'developing', '008', 19],
  ['143', '防走失定位卡', '通过定位卡查看位置、安全区域和紧急求助信息', 'MapPin', '/anti-lost-card', 'developing', '008', 20],
  ['144', '随身视觉助手', '通过图像识别和语音描述辅助识物、读字与环境感知', 'Zap', '/visual-assistant', 'developing', '008', 21],
  ['145', 'AI面试练习室', '模拟真实面试问答并提供表达分析和改进建议', 'Briefcase', '/ai-interview', 'developing', '008', 22],
  ...
  ['153', '人才服务', '覆盖人才认定、政策匹配、补贴申领和人才档案', 'Users', '/talent', 'developing', '009', 30],
];
